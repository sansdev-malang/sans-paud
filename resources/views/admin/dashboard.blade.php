                ...
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            ...
                            @else
                                <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-50 font-nasalization">Riwayat Perolehan Bonus Harian</h3>
                                <p class="text-xs text-slate-500 dark:text-slate-400">Perolehan bonus kehadiran harian Anda pada 7 hari aktif terakhir</p>
                            @endif
                        </div>
                    </div>
                        ...
                        <svg viewBox="0 0 500 150" class="w-full h-full chart-line overflow-visible">
                            ...
                            <defs>
                                <linearGradient id="grad-area" x1="0" y1="0" x2="0" y2="1">
                                    <stop offset="0%" stop-color="currentColor" class="text-indigo-600 dark:text-indigo-450" />
                                    <stop offset="100%" stop-color="currentColor" class="text-indigo-600 dark:text-indigo-450" stop-opacity="0" />
                                </linearGradient>
                            </defs>
                        </svg>
                    </div>
